      ...
      <div class="product-info">
        ...
        <div class="product-price-btn">
          <p><span>฿ <?= number_format($row['pro_price'], 2); ?></span></p>
            ...
            <a href="user_page.php" class="btn">หน้าแรก<span>&#8594;</span></a>
      </div>
      
      <a href="order_product.php?pro_id=<?= $row['pro_id']; ?>&act=add" class="btn" style="margin-left : 60px;" target="_blank">เพิ่มลงตะกร้า<span>&#8594;</span></a>
